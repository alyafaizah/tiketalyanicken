...
<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled page-loading">
    ...
    <script src="{{ asset('/assets/js/pages/crud/ktdatatable/base/data-local.js?v=7.2.9') }}"></script>
    <!-- Halaman data pemesanan tiket -->
    <script src="{{ asset('/assets/js/pages/crud/ktdatatable/base/data-ajax.js?v=7.2.9') }}"></script>
    <!--end::Page Scripts-->
</body>
<!--end::Body-->
